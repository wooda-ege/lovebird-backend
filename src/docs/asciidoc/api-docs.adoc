...
----
{
    "authToken": "eyJhbGciOiJIUzUxMiJ9.eyJpZCI6IjEiLCJleHAiOjE2ODc2ODE2MzB9.dWIbrC0spNgY9EBDIZ9skEhmNXIJqjt5hdo_nPw4QHNAWYhEXiCEV9_pmObbWvlxOx-CnDUMm-IhooKwPaPKCA"
}
----
...
----
{
    "authToken": "eyJhbGciOiJIUzUxMiJ9.eyJpZCI6IjIiLCJleHAiOjE2ODc2ODE3MzB9.HyPVJRKqAMm75NRmVMb22PuzZNQoIoJrRyjVsuYooMfRGx6nQikvuoUA5byLo7chrzORHinvMFOw86EdmzjJRQ"
}
----
...
include::{snippets}/auth-apple/http-request.adoc[]

include::{snippets}/auth-apple/request-fields.adoc[]

==== Response

include::{snippets}/auth-apple/http-response.adoc[]

include::{snippets}/auth-apple/response-fields.adoc[]
